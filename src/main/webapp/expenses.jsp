<%@ page import="java.util.ArrayList,ru.mycash.domain.Count,ru.mycash.domain.Expense,ru.mycash.domain.ExpenseCategory,ru.mycash.dao.MySqlCountDao,ru.mycash.dao.MySqlExpenseCategoryDao" %>
<!DOCTYPE html>
<html>
  <head>
